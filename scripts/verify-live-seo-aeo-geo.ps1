...
$checks = @(
  ...
  @{ Path = "/search.html"; Contains = "Search Jason" },
  @{ Path = "/search.html"; Contains = "Official site search" },
  @{ Path = "/search.html"; Contains = "Dean's Honor List" },
  @{ Path = "/search.html"; Contains = "SearchResultsPage" },
  @{ Path = "/search.html"; Contains = "/.well-known/ai-profile.jsonld" },
  @{ Path = "/search.html"; Contains = "/.well-known/ai-answers.json" },
  @{ Path = "/search.html"; Contains = "/CITATION.cff" },
  ...
  @{ Path = "/sitemap.xml"; Contains = "$BaseUrl/search.html" },
  ...
  @{ Path = "/robots.txt"; Contains = "Site-Search: $BaseUrl/search.html" },
  ...
  @{ Path = "/schema.json"; Contains = "search.html?q={search_term_string}" },
  @{ Path = "/schema.json"; Contains = "SearchResultsPage" },
  @{ Path = "/schema.json"; Contains = "https://jasonobawemimo.com/search.html#search-results-page" },
  @{ Path = "/schema.json"; Contains = "https://jasonobawemimo.com/search.html#breadcrumbs" },
  ...
  @{ Path = "/opensearch.xml"; Contains = "https://jasonobawemimo.com/search.html?q={searchTerms}" },
