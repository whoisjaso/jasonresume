...
$checks = @(
  ...
  @{ Path = "/llms.txt"; Contains = "v2026.06.17-entity-discovery" },
  ...
  @{ Path = "/llms-full.txt"; Contains = "v2026.06.17-entity-discovery" },
  @{ Path = "/ai.txt"; Contains = "AI Retrieval Guidance" },
  @{ Path = "/ai.txt"; Contains = "github.com/whoisjaso/whoisjaso" },
  @{ Path = "/ai.txt"; Contains = "v2026.06.17-entity-discovery" },
  ...
  @{ Path = "/jason-obawemimo.md"; Contains = "v2026.06.17-entity-discovery" },
  ...
  @{ Path = "/person.json"; Contains = "v2026.06.17-entity-discovery" },
  ...
  @{ Path = "/jason-obawemimo.vcf"; Contains = "v2026.06.17-entity-discovery" },
  ...
  @{ Path = "/.well-known/ai.txt"; Contains = "v2026.06.17-entity-discovery" },
  ...
  @{ Path = "/.well-known/webfinger"; Contains = "v2026.06.17-entity-discovery" },
  ...
  @{ Path = "/.well-known/host-meta"; Contains = "v2026.06.17-entity-discovery" },
  ...
  @{ Path = "/schema.json"; Contains = "v2026.06.17-entity-discovery" },
  ...
  @{ Path = "/profile.jsonld"; Contains = "v2026.06.17-entity-discovery" },
